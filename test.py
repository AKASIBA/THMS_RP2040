...
xbe_reset = Pin(28, Pin.OUT, value=1)
buf_t = bytearray(7)
...
def time_calibration():
    ...
    while True:
        ...
        if uart_data:
            print(uart_data[:2])
            if uart_data[:2] == '48' and len(uart_data) == 14:
                try:
                    buf = bytearray(7)
